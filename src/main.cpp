...
CBigNum bnProofOfWorkLimit(~uint256(0) >> 2);
...
unsigned int nStakeMinAge = 60 * 60 * 2; // 2 hour
...
const string strMessageMagic = "iconicx Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 10004)
    {
        nSubsidy = 100 * COIN;
    }
...
// iconicx: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "iconicx", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Wall St. ends with modest decline after Fed - Wed Oct 29, 2014 4:28pm EDT";
        CTransaction txNew;
        txNew.nTime = 1414614480;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 51725 << CBigNum(9999) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x8d235bfd43077f19b7b395be546f4b447778c6648019b049485cbeabc2366259"));
        block.print();
